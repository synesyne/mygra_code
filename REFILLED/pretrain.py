...
def display_args(args):
    ...
    print('==if the model is ViT, the arguments are:==')
    print('vit_image_size = %d' % (args.vit_image_size))
    print('vit_patch_size = %d' % (args.vit_patch_size))
    print('vit_num_classes = %d' % (args.vit_num_classes))
    print('vit_dim = %d' % (args.vit_dim))
    print('vit_depth = %d' % (args.vit_depth))
    print('vit_heads = %d' % (args.vit_heads))
    print('vit_mlp_dim = %d' % (args.vit_mlp_dim))
    print('vit_channels = %d' % (args.vit_channels))   
    print('vit_dim_head = %d' % (args.vit_dim_head)) 
    print('vit_dropout = %f' % (args.vit_dropout))
    print('vit_emb_dropout = %f' % (args.vit_emb_dropout))
...
if __name__ == '__main__':
    ...
    # task arguments
    parser.add_argument('--data_name', type=str, default='CIFAR-100', choices=['CIFAR-100', 'CUB-200', 'CUB-f100'])
    parser.add_argument('--network_name', type=str, default='wide_resnet', choices=['resnet', 'wide_resnet', 'mobile_net', 'vit'])# 现在还有'vit'
