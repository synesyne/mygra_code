# CUB后100个类别数据，将对应地类别从101-200改为1-100
# -*- coding: utf-8 -*-
import pickle
import os
import cv2
...
class MyDataset(Dataset):
    def __init__(self, data_path, flag_mode, flag_tuning):
        ...
        with open(os.path.join(self.root, 'images.txt')) as f:
            for line in f:
                ...
                self.images_path[int(image_id) - 5864] = path
        ...
        with open(os.path.join(self.root, 'image_class_labels.txt')) as f:
            for line in f:
                ...
                self.class_ids[int(image_id) - 5864] = int(class_id) - 100
            ...
            with open(os.path.join(self.root, 'train_test_split.txt')) as f:
                for line in f:
                    ...
                    if int(is_train):
                        ...
                        self.data_id.append(int(image_id) - 5864)
    ...
    def get_n_classes(self):
        return 100 # 先使用全部数据，是200个类别，都使用了100个类别
